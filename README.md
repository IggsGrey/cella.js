...
- Store any data type without needing to convert to a string first.
- Ability to add custom storage engine.
- Ability to add custom functions to be executed before and after data is inserted.
...
# Contributing
Want to contribute? Great! I am currently seeking contributors for remaining features including adding in-built support for more DB engines.
...
![atom](https://badgen.net/apm/v/linter)<br/>
![firefox good](https://code.cdn.mozilla.net/for-firefox/badges/assets/Developers_For_Firefox_Dark.png)